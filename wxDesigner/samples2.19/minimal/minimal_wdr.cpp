//------------------------------------------------------------------------------
// Source code generated by wxDesigner from file: minimal.wdr
// Do not modify this file, all changes will be lost!
//------------------------------------------------------------------------------

#if defined(__GNUG__) && !defined(NO_GCC_PRAGMA)
    #pragma implementation "minimal_wdr.h"
#endif
...
wxSizer *MyDialogFunc( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    copyright_sizer = item1;

    wxStaticText *item3 = new wxStaticText( parent, ID_TEXT, wxT("Copyright 2002 T. Coon. 1000,- ") __WDR_EURO__ wxT("."), wxDefaultPosition, wxDefaultSize, 0 );
